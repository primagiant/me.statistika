                        ...
                        <tbody>
                            <tr>
                                ...
                                <td
                                    ...
                                    <a href=""
                                        class="bg-cyan-500 text-white hover:bg-cyan-600 text-xs font-bold uppercase px-3 py-1 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                                        type="button">
                                        Edit
                                    </a>
                                </td>
